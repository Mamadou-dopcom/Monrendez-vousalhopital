...
?>
<div class="container">
 	<h1>Bienvenue dans le systeme de gestion hospitaliere de Project Worlds</h1>
  ...
  <?php 
    if(isset($_POST['lemail'])){
      ...
      echo "<div class='alert alert-info'>
              <strong>Info!</strong> Connectez-vous ou inscrivez-vous pour pouvoir réserver votre rendez-vous.</div>";
    }
    unset($_POST);
  ?>
<div class="row">
